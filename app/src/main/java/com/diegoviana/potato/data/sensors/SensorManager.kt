...
class SensorManager(private val context: Context) {
    ...
    private val heartRateSensor = sensorManager.getDefaultSensor(android.hardware.Sensor.TYPE_HEART_RATE)
    ...
    private val sensorListener = object : SensorEventListener{
        override fun onSensorChanged(event: SensorEvent) {
            when (event.sensor.type) {
                ...
                Sensor.TYPE_ACCELEROMETER -> {
                    ...
                    lastMovementX = event.values[1]
                    lastMovementX = event.values[2]
                }
            }
            simulateEdaAndTemp()
            updateSensorData()
        ...
        override fun onAccurracyChanged(sensor: Sensor, accurrancy: Int) {
            // Not used
        }
    }
    ...
    private fun simulateAllSensorData() {
    ...
    private fun updateSensorData() {
        _sensorData.value = SensorData(
            timestamp = SensorData.getCurrentTimesMillis(),
